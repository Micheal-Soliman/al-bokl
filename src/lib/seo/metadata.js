...
export const generatePageMetadata = ({
  ...
  return {
    title: fullTitle,
    description: description || 'د. أسامة البكل، إستشاري طب وجراحة أمراض الذكورة وتأخر الإنجاب بطب قصر العيني. خبرة +10 سنوات في علاج مشاكل الذكورة والإنجاب.',
...
export const staticMetadata = {
  home: generatePageMetadata({
    ...
    description: 'د. أسامة البكل، إستشاري طب وجراحة أمراض الذكورة وتأخر الإنجاب بطب قصر العيني. خبرة +10 سنوات في علاج مشاكل الذكورة والإنجاب.',
    path: '/'
  }),
