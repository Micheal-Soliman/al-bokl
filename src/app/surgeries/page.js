...
export default function SurgeriesPage() {
  const surgicalProcedures = [
    {
      ...
      description:
        "علاج دوالي الخصيتين بالجراحة الميكروسكوبية لتحسين الخصوبة وتخفيف الألم",
      benefits: [
    ...
    },
    {
      ...
      description:
        "زراعة دعامات للرجال الذين يعانون من ضعف انتصاب شديد لا يستجيب للعلاج الدوائي",
      benefits: [
    ...
    },
    {
      ...
      description:
        "تصحيح انحناء القضيب الذي يؤثر على الوظيفة الجنسية والراحة النفسية",
      benefits: [
        "تصحيح الانحناء",
  ...
  const statistics = [
    ...
    { number: "", label: "متابعة منتظمة بعد العملية . " },
  ];
          ...
          <div className={styles.container}>
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroDescription}>
                نقدم مجموعة شاملة من العمليات الجراحية المتخصصة في أمراض الذكورة
                باستخدام أحدث التقنيات الطبية ومعايير الجودة العالمية لضمان أفضل
                النتائج وأعلى معدلات النجاح.
              </p>
          ...
          <div className={styles.container}>
            <div className={styles.introContent}>
              <h2 className={styles.sectionTitle}>
                الجراحة الميكروسكوبية المتقدمة
              </h2>
              <div className={styles.introText}>
                <p>
                  نتخصص في الجراحة الميكروسكوبية لأمراض الذكورة، والتي تتطلب دقة
                  عالية وخبرة واسعة. استخدام الميكروسكوب الجراحي يضمن دقة أكبر،
                  مضاعفات أقل، وشفاء أسرع.
                </p>
                <p>
                  جميع عملياتنا تتم في مستشفيات مجهزة بأحدث التقنيات، مع فريق
                  طبي متخصص ومتابعة شاملة لضمان أفضل النتائج وراحة المريض.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className={styles.cardHeader}>
                    ...
                    <span
                      className={`${styles.complexityBadge} ${
                        styles[procedure.complexity.replace(" ", "")]
                      }`}
                    >
        ...
        <section className={styles.ctaSection}>
          <div className={styles.container}>
            <div className={styles.ctaContent}>
              ...
              <p>
                لا تدع المشاكل الصحية تؤثر على جودة حياتك. احجز استشارة مع د.
                أسامة البكل لتقييم حالتك ومناقشة الخيارات الجراحية المناسبة.
              </p>
