            ...
            <div className={styles.contentWrapper}>
              ...
              <div className={styles.section}>
                ...
                <p className={styles.treatmentIntro}>
                  العلاج الوحيد لدوالي الخصية هو العملية ، مفيش حاجة اسمها علاج
                  بالاعشاب ولا بالمايه السخنه .
                </p>
                <p className={styles.treatmentWarning}>
                  بس و انت بتاخد قرار العملية لازم تبعد عن الجراحة بالمنظار و
                  الاشعه التداخيله و هنعرف دلوقت ليه .
                </p>
              </div>
              ...
              <div className={styles.surgerySection}>
                ...
                <div className={styles.surgeryProblemsList}>
                  ...
                  <div className={styles.surgeryProblem}>
                    <span className={styles.problemBullet}>•</span>
                    <p>
                      ممكن نعرض الشريان الخصوي اللي بيغذي الخصية بالدم للقطع ،
              ...
              <div className={styles.recoverySection}>
                ...
                <div className={styles.recoveryList}>
                  ...
                  <div className={styles.recoveryItem}>
                    <span className={styles.recoveryBullet}>•</span>
                    <p>
                      و كمان بنقدر اننا نمارس العلاقة الزوجية بعد أسبوع من وقت
                      العملية .
                    </p>
                  </div>
                </div>
