      ...
      <div className={styles.breadcrumb}>
        <div className={styles.container}>
          <nav className={styles.breadcrumbNav}>
            ...
            <Link href="/articles" className={styles.breadcrumbLink}>المقالات</Link>
            <span className={styles.breadcrumbSeparator}>|</span>
          ...
          <aside className={styles.sidebar}>
            ...
            <div className={styles.widget}>
              ...
              <div className={styles.recentArticles}>
                <Link href="/articles/local-injections-erectile-dysfunction" className={styles.recentArticle}>
                  <span className={styles.recentDate}>30 أغسطس، 2025</span>
                  <span className={styles.recentTitle}>ما هي الحقن الموضعية المستخدمة في علاج ضعف الانتصاب؟</span>
                </Link>
                <Link href="/articles/sperm-abnormality-miscarriage" className={styles.recentArticle}>
                  <span className={styles.recentDate}>30 أغسطس، 2025</span>
                  <span className={styles.recentTitle}>هل تشوه الحيوانات المنوية سبب الاجهاض المتكرر؟</span>
                </Link>
                <Link href="/articles/when-varicocele-dangerous" className={styles.recentArticle}>
                  <span className={styles.recentDate}>28 أغسطس، 2025</span>
                  <span className={styles.recentTitle}>متى تكون دوالي الخصية خطيرة؟</span>
                </Link>
                <Link href="/articles/sudden-penis-relaxation" className={styles.recentArticle}>
                  <span className={styles.recentDate}>27 أغسطس، 2025</span>
                  <span className={styles.recentTitle}>ما هو سبب ارتخاء القضيب فجأة أثناء العلاقة الزوجية؟</span>
                </Link>
                <Link href="/articles/penile-implants-chronic-diseases" className={styles.recentArticle}>
                  <span className={styles.recentDate}>26 أغسطس، 2025</span>
                  <span className={styles.recentTitle}>هل دعامة الانتصاب تنفع لأصحاب الأمراض المزمنة؟</span>
                </Link>
              </div>
            </div>
            ...
            <div className={styles.widget}>
              ...
              <div className={styles.categories}>
                <Link href="/articles/category/general" className={styles.categoryItem}>
                  <span>مقالات عامة</span>
                  <span className={styles.categoryCount}>44</span>
                </Link>
                <Link href="/articles/category/infertility" className={styles.categoryItem}>
                  <span>تأخر الإنجاب</span>
                  <span className={styles.categoryCount}>49</span>
                </Link>
                <Link href="/articles/category/sexual-problems" className={styles.categoryItem}>
                  <span>المشاكل الجنسية</span>
                  <span className={styles.categoryCount}>44</span>
                </Link>
                <Link href="/articles/category/varicocele" className={styles.categoryItem}>
            ...
            <div className={styles.widget}>
              ...
              <div className={styles.contactWidget}>
                ...
                <p className={styles.contactNote}>لا تخجل أو تتأخر في التواصل معنا</p>
              </div>
            </div>
          </aside>
