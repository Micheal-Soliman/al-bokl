        ...
        <div className="container">
          ...
          <div className={styles.beliefsContent}>
            <p>
              ...
              , ونؤمن أن هذا من أفل حقوقكم علينا , شفائكم ورسم البسمة في قلوبكم
          ...
          <div className={styles.missionVisionGrid}>
            <div className={styles.missionCard}>
              ...
              <p>
                ...
                أفضلها نتيجة وأسرعها, مع المتابعة الدقيقة لحالة المريض بعض خطوة
        ...
        <div className="container">
          <div className={styles.processGrid}>
            ...
            <div className={styles.processStep}>
              ...
              <p>
                هي من أهم عوامل نجاح التدخل الجراحي , فمن الممكن أن نلدأ أحياناً
