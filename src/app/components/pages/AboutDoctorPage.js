          ...
          <div className={styles.heroContent}>
            <div className={styles.heroText}>
              ...
              <p className={styles.doctorTitle}>
                مدرس واستشاري طب وجراحة أمراض الذكوره وتأخر الإنجاب والصحة الجنسية بطب قصر العيني
              </p>
              <p className={styles.experience}>
                خبرة أكثر من 10 سنوات فى : علاج تأخر الإنجاب والمشاكل الجنسية وتأخر البلوغ
              </p>
            ...
            <div className={styles.heroImage}>
              <img src="/images/doctor-osama.webp" alt="الدكتور أسامة البكل" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.beliefsSection}>
        <div className="container">
          ...
          <div className={styles.beliefsContent}>
            <p>
              هو أن لكل مرض أكثر من طريق للعلاج , لكن أيهما أفضل وأسرع كنتيجة – وأقل تكلفة علي المريض , 
              هذا هو ما نعمل لتحقيقة بعد توفيق الله لنا , ونؤمن أن هذا من أفل حقوقكم علينا , شفائكم ورسم 
              البسمة في قلوبكم وعلي وجوهكم هي أعظم رسالة نسعي من أجلها بتوفيق الله .
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className={styles.missionVisionGrid}>
            <div className={styles.missionCard}>
              <h3>مهمتنا</h3>
              <p>
                هي الوصول إلي التشخيص الصحيح لمشكلة المريض , ومن ثم وضع كل الحلول العلاجية سواء كان علاج 
                دوائي أو عملية جراحية, وإختيار أفضلها نتيجة وأسرعها, مع المتابعة الدقيقة لحالة المريض بعض 
                خطوة العلاج حتي مرحلة التعافي نهائياً .
              </p>
            </div>
            <div className={styles.visionCard}>
              <h3>رؤيتنا</h3>
              <p>
                هي أن نصبح المصدر الأول والأخير فى مصر والوطن العربي فى تثقيف كل مريض بحالته وبكل تفاصيلها , 
                سواء كان لدية مشكلة فى تأخر الإنجاب أو مشكلة جنسية أو تأخر فى البلوغ .
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={styles.blogSection}>
        <div className="container">
          ...
          <div className={styles.blogContent}>
            <p>
              نقوم بنشر كل المعلومات الطبية لتوعية وتثقيف المرضي بكل تفاصيل حالتهم , وتوجيههم إلي الطريق 
              الأقرب والأصح للعلاج , بعيداً كل البعد عن ما إذا كان المريض سيتوجه إلينا أو لغيرنا من الأساتذه 
              الأطباء الكبار للبدء في العلاج .
            </p>
            <p>
              كل ما يهمنا هو تثقيف المريض بحالته والتوجيه الصحيح لأقرب وأفضل طرق العلاج , وعلي المريض بعد 
              ذلك الإختيار .
            </p>
        ...
        <div className="container">
          <div className={styles.processGrid}>
            <div className={styles.processStep}>
              ...
              <p>
                لابد وأن نتأكد بكافة الطرق والسبل أنه ليس هناك بديل للعلاج سوي التدخل الجراحي , وأن للتدخل 
                الجراحي نتائجة الإيجابية المضمونة بالفعل .
              </p>
            </div>
            ...
            <div className={styles.processStep}>
              ...
              <p>
                هي من أهم عوامل نجاح التدخل الجراحي , فمن الممكن أن نلدأ أحياناً للعلاج الدوائي قبل العملية 
                وذلك للحصول علي أعلي نسبة نجاح ممكنة من التدخل الجراحي .
              </p>
            </div>
            
            <div className={styles.processStep}>
              <h3>متباعة ما بعد العملية حتي التعافي</h3>
              <h4>علاقتنا بالمرضي لم تنتهي أبداً</h4>
              <p>
                وإهتمامنا بالمريض بعد العملية حتي التعافي هو النجاح الفعلي الذي نسعي دائماً إليه , حتي بعد 
                التعافي لم تنتهي العلاقة , فنحن دائما بجوارك متي إحتجت إلينا ❤️
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className={styles.contactGrid}>
            ...
            <div className={styles.contactCard}>
              ...
              <Link href="mailto:Booking@albokl.com" className={styles.contactBtn}>
                راسلنا
              </Link>
            </div>
