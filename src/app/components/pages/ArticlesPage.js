...
import { medicalArticles, articleCategories } from '../../../data/articles/articlesData';
...
const ArticlesPage = () => {
  ...
  const filteredArticles = selectedCategory === 'جميع المقالات' 
    ? medicalArticles 
    : medicalArticles.filter(article => article.category === selectedCategory);
  ...
  const featuredArticles = [
    ...
    },
    {
      ...
      excerpt: "دليل شامل حول أنواع دعامات العضو الذكري ومعدلات النجاح والمضاعفات المحتملة.",
      author: "د. أسامة البكل",
      date: "8 سبتمبر 2025",
    ...
    },
    {
      ...
      excerpt: "شرح مفصل لعملية التفتيش الميكروسكوبي ودواعي إجرائها ومعدلات النجاح.",
      author: "د. أسامة البكل",
      date: "5 سبتمبر 2025",
      category: "تأخر الإنجاب",
      readTime: "6 دقائق",
    ...
    },
    {
      ...
      excerpt: "دليل شامل حول مشاكل البلوغ المبكر والمتأخر عند الذكور وطرق العلاج الحديثة.",
      author: "د. أسامة البكل",
      date: "3 سبتمبر 2025",
              ...
              <Link href={`/articles/${article.slug}`} key={article.id} className={styles.articleCard}>
                ...
                <div className={styles.articleContent}>
                  ...
                  <div className={styles.articleMeta}>
                    ...
                    <span className={styles.date}>{new Date(article.publishedDate).toLocaleDateString('ar-EG')}</span>
                    <span className={styles.readTime}>{article.readTime} دقائق</span>
                  </div>
                </div>
              </Link>
            ))}
