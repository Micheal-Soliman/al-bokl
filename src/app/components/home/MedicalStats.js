      ...
      <div className="container">
        <div className={styles.content}>
          ...
          <div className={styles.textContent}>
           ...
           نقوم بإجراء عدد كبير من العمليات الجراحية بشكل مستمر، ومع كل عملية بنضيف خبرة جديدة ونطوّر من مهاراتنا وتقنياتنا، علشان نضمن أعلى معدلات النجاح وأفضل النتائج العلاجية لكل مريض.
اعتمادنا على أحدث التقنيات الجراحية، بالإضافة إلى التدريب المستمر، بيساعدنا على الوصول للنتيجة اللي المريض بيدور عليها بأمان كامل وبدقة عالية في كل خطوة من خطوات العملية.
