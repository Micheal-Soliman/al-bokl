...
export default function TreatmentServices() {
  const services = [
...

    {
      ...
      subtitle: `من بعد سن 14 سنة`,
      description: `تأخّر البلوغ عند الأولاد يُشخَّص عندما يتجاوز الطفل سن 14 سنة دون ظهور العلامات الطبيعية للبلوغ. وكلما كان الكشف وبدء العلاج مبكرًا بعد هذا السن، كانت النتائج أفضل بكثير؛ حيث تتحسّن الاستجابة للعلاج ويقلّ تأثير التأخّر على النمو النهائي للطول، وصحة وكثافة العظام، وكذلك على القدرة الإنجابية والقدرة الجنسية في المستقبل.`,
