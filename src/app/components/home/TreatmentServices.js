...
export default function TreatmentServices() {
  const services = [
    ...
    },
    {
      ...
      description:
        "علاج متخصص لمشاكل البرودة الجنسية عند النساء مع تقديم الاستشارة الطبية المتخصصة والعلاج المناسب.",
        ...
        <div className={styles.header}>
          <div className={styles.headerContent}>
            ...
            <p className={styles.description}>
              إبتداءاً من البحث عن السبب الرئيسي للمشكلة , ومن ثم إقتراح كل
              الطرق الممكنة للعلاج , والمفاضله بينهم من حيث النتائج والظروف
              الإقتصادية للمريض , مع الأخذ في الإعتبار الرغبة في الحصول علي أعلي
              النتائج الممكنة والتخلص من المشكلة نهائياً .
            </p>
          </div>
