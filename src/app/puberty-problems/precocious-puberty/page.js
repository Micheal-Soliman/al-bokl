...
export async function generateMetadata() {
  return generateSEOMetadata({
    ...
    description: "البلوغ المبكر ممكن يحصل للطفل وهو عمره 9 سنين، بس ده مش معناه انه وضعه كدة طبيعي، لان البلوغ المبكر ممكن يسبب له مشاكل صحية ونفسية كثير جدا تفضل معاه طول حياته.",
    keywords: ["البلوغ المبكر", "البلوغ المبكر عند الذكور", "علاج البلوغ المبكر", "هرمونات البلوغ", "النمو المبكر", "د أسامة البكل", "أعراض البلوغ المبكر", "أسباب البلوغ المبكر"],
...
export default function PrecociousPubertyPage() {
  const pubertyDefinition = {
    title: "البلوغ المبكر",
    description: "البلوغ المبكر مش معناه ان الطفل كده صحته الجنسية والانجابية كويسه، البلوغ المبكر مرض ولازم نهتم اننا نعالج اطفالنا لو ده حصلهم، لان البلوغ المبكر ليه اضرار صحية ونفسية كتير على الطفل.",
    whatIsPuberty: "البلوغ هو التغيرات الفسيولوجية اللي بتحصل للأطفال عشان تنقلهم من مرحلة الطفولة لمرحلة البلوغ، واللي فيها بيكون عندنا القدرة اننا نمارس العلاقة الجنسية، وبيكون كمان عندنا قدرة على الانجاب.",
    earlyPuberty: "وبالنسبة البلوغ المبكر فهو المقصود بيه الوصول لمرحلة البلوغ قبل الوقت الطبيعي اللي هو من سن 9 – 14 سنه، والبلوغ هنا ممكن يحصل للطفل وهو عمرة 9 سنين."
  };
  ...
  const complications = [
    ...
    },
    {
      ...
      description: "تانى مشكلة ان احنا قولنا ان البلوغ المبكر ده بيكون بسبب مرض، زي خلل الهرمونات، اللي لو أهملناها ومعرفناش ان فيه مشكلة بسبب اننا متابعناش الطفل لما حصلة بلوغ مبكر، وقتها الهرمونات دي ممكن تأثر على الجسم كله، وتسبب للطفل مشاكل اكتر."
    },
    {
      title: "مشاكل نفسية",
      description: "واخيراّ البلوغ المبكر هيسبب للطفل مشاكل نفسية، لأنه هيحس ديماّ ان هو فيه مشكله وانه مختلف عن باقي الاطفال اللي في سنه، غير ان بسبب سنه الصغير مش هيكون قادر انه يفهم التغيرات اللي حصلت في جسمه او فاهم سببها ايه، و ده هيسبب قلق وتوتر للطفل، لأنه فجأة اتحول من طفل، لشاب في تكوين الجسم بس، لكن عقلة لسه عقل طفل."
    }
  ];
    ...
    <MainLayout>
      <div className={styles.pubertyPage}>
            ...
            <div className={styles.heroContent}>
              <div>
                ...
                <p className={styles.heroDescription}>
                  البلوغ المبكر ممكن يحصل للطفل وهو عمره 9 سنين، بس ده مش معناه انه وضعه كدة طبيعي، 
                  لان البلوغ المبكر ممكن يسبب له مشاكل صحية ونفسية كثير جدا تفضل معاه طول حياته.
                </p>
        ...
        <section className={styles.problemsSection}>
          <div className={styles.container}>
            ...
            <div className={styles.definitionCard}>
              <p className={styles.definitionText}>{pubertyDefinition.description}</p>
              
              <div className={styles.pubertyExplanation}>
                <h3 className={styles.subTitle}>وقبل ما نعرف يعنى ايه بلوغ مبكر، تعالوا الاول نعرف يعنى اى بلوغ</h3>
                <p className={styles.explanationText}>{pubertyDefinition.whatIsPuberty}</p>
                <p className={styles.explanationText}>{pubertyDefinition.earlyPuberty}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={styles.supportSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>أعرف أزاي ان أبني عنده بلوغ مبكر ؟</h2>
            <div className={styles.howToKnowCard}>
              <p className={styles.howToKnowText}>
                اعراض البلوغ المبكر نفسها مش بتكون مختلفة عن الاعراض اللي بتظهر في الوقت الطبيعي بس الفرق هنا في الوقت اللي بتظهر فيه اعراض البلوغ انه بيكون في سن 9 سنوات، وممكن البلوغ ده يحصل بشكل تدريجي او بشكل مفاجئ في حالات معينه هنعرفها كمان شويه.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.supportSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>تعالوا بقي دلوقتى نعرف اى هي علامات البلوغ ؟</h2>
            <div className={styles.symptomsCard}>
              ...
              <p className={styles.symptomsNote}>
                ودلوقتي بعد ما عرفنا يعنى اي بلوغ واي هي علاماته، تعالوا بقي نعرف دلوقتى
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.normalPubertySection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>طيب أزاي بنعالج البلوغ المبكر ؟</h2>
            <div className={styles.treatmentCard}>
              <p className={styles.treatmentText}>{treatmentInfo.description}</p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.treatmentSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>خلينى دلوقتي اجاوبك على سؤال اكيد انت بتفكر فيه، وهو اي اللي هيحصل يعنى لو معالجناش البلوغ المبكر؟</h2>
            <div className={styles.complicationsIntro}>
              <p className={styles.complicationsText}>
                ممكن تكون فاكر ان البلوغ المبكر ده حاجة كويسه وان ابنك خلاص كبر وبقي راجل، لكن خلينى اقولك ان ده مش صح البلوغ المبكر مرض ولو ما عالجنهوش هيسبب للطفل اضرار زي:
              </p>
            </div>
            <div className={styles.complicationsList}>
              {complications.map((comp, index) => (
                <div key={index} className={styles.complicationCard}>
                  ...
                  <p className={styles.complicationDescription}>{comp.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className={styles.container}>
            <div className={styles.finalMessageCard}>
              <p className={styles.finalMessageText}>
                و في النهاية خلينا نتأكد ان مهم جدا كل أب وأم يكونوا بيتابعوا نمو أولادهم كويس سواء من ناحية نمو الجسم أو نمو الأعضاء التناسلية عشان لو حصل اى حاجة مش طبيعية في فترة بلوغ الطفل لازم نكشف عليه، و نعالجه في اقرب وقت عشان نبعد عن اى مضاعفات او مشاكل ممكن تحصل للطفل.
              </p>
              <p className={styles.finalMessageText}>
                و دلوقتى لو اخدتوا قرار انكم عاوز تطمنوا على ابنكم تقدروا تتواصلوا مع فريقنا الطبي، <strong>01018874287</strong> و هما هيحددولكم اقرب معاد مع د/أسامة محمد البكل مدرس واستشاري طب وجراحة أمراض الذكورة و تأخر الإنجاب و الصحة الجنسية بطب القصر العيني، عشان نطمن على اولادنا.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.ctaSection}>
          <div className={styles.container}>
            <div className={styles.ctaContent}>
              ...
              <p>
                البلوغ المبكر حالة قابلة للعلاج بنجاح عالي. تواصل معنا الآن للحصول على 
                استشارة طبية متخصصة وخطة علاج مناسبة لطفلك.
              </p>
