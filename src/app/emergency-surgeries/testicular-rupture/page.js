...
export async function generateMetadata() {
  return generateSEOMetadata({
    ...
    description: "اصابة الخصية بيكون ناتج عن إصابة شديدة في الخصية زي لو بنمارس رياضه زى كرة القدم مثلا و الكوره اتخبطت بقوة فى الخصية",
    keywords: ["تهتك الخصية", "إصابة الخصية", "انفجار الخصية", "جراحة طوارئ الخصية", "إصابات رياضية", "د أسامة البكل", "كيس الصفن", "نزيف الخصية"],
...
export default function TesticularRupturePage() {
  ...
  const emergencyTreatment = {
    immediate: "و طبعا كل الاعراض دي هتظهر بعد خبطة قوية و مباشره للخصية، و لو حسينا بالاعراض دى وقتها لازم نتحرك فوراّ على المستشفى، و لحد ما نوصل ممكن ناخد مسكن نقلل بيه الالم، و نحاول نعمل كمدات تلج عشان نقلل التورم، و نحاول اننا نرفع كيس الصفن و نقلل حركته على قد ما نقدرعشان نقلل من ضرر الاصابه لحد ما نوصل المستشفى",
    hospital: "و اول ما نوصل المستشفى هنعمل فحص و اشعة دوبلر على الخصية عشان نحدد وضع الدوره الدموية فى الخصية و حجم الاصابة، و لو لقينا من الفحص ان الاصابه كبيره وفى نزيف داخلى فده معناه ان حصل تهتك فى انسجة الخصية او قطع فى الغشاء المحيط بيها وقتها لازم يكون فى تدخل جراحى نوقف بيه النزيف اللى حصل و نعالج الانسجة اللى اتضررت او نستأصلها، و نخيط القطع اللى حصل فى غلاف الخصية",
    urgency: "و هنا لازم نعرف حاجة مهمه ان كل ده لازم يتم بسرعه، لان لو حصل تأخير ده ممكن يسبب غرغارينا لانسجة الخصية، و نضطر اننا نستأصلها"
  };
  ...
  const prevention = {
    title: "و دلوقتى خلينى اقولك ان فى طرق نقدر اننا نحمى بيها الخصية من ان يحصلها تهتك زى :",
    method: "اننا لو بنمارس رياضه ممكن اننا نتعرض بسببها لخبطة فى الخصية، فأحنا ممكن نلبس واقى من البلاستك، الواقى ده بيغطى الخصية و العضو الذكرى، و بكده هنكون بنحميهم و لو حصل و اتخبطنا فده مش هيضر بالخصية و لا العضو الذكرى"
  };

  const finalMessage = "و اخيراّ خليك عارف ان اى مشكلة صحية علاجها فى الاول بيكون سهل، لكن لو اتأخرنا عليها بيكون الوضع اصعب و ممكن ميكونش ليه علاج، و دلوقتى لو عندك اى استفسار تقدر تتواصل معانا على رقم 01018874287 و فريقنا الطبي هيجاوب على كل اسئلتك.";
    ...
    <MainLayout>
      <div className={styles.emergencyPage}>
        ...
        <section className={styles.definitionSection}>
          <div className={styles.container}>
            ...
            <div className={styles.definitionCard}>
              <p className={styles.definitionText}>{ruptureDefinition.description}</p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.causesSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>تعالوا دلوقتى نعرف اى اللى ممكن يسبب تهتك للخصية :</h2>
        ...
        <section className={styles.symptomsSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>و بعد ما عرفنا امتى ممكن يحصل تهتك للخصية، تعالوا دلوقتى نعرف اى هى اعراض تهتك الخصية :</h2>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.treatmentSteps}>
              <div className={styles.treatmentStep}>
                ...
                <p className={styles.stepText}>{emergencyTreatment.immediate}</p>
              </div>
        ...
        <section className={styles.postOpSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>و دلوقتى تعالوا نعرف اى اللى بيحصل بعد العمليه :</h2>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.preventionCard}>
              ...
              <div className={styles.relatedLink}>
                <p>و لو عاوز تعرف معلومات اكتر عن <Link href="/emergency-surgeries/penile-fracture" className={styles.inlineLink}>كسر العضو الذكرى اضغط هنا</Link></p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={styles.ctaSection}>
          <div className={styles.container}>
            <div className={styles.ctaContent}>
              ...
              <p>
                تهتك الخصية حالة طوارئ تحتاج تدخل فوري. العلاج السريع يمكن أن ينقذ الخصية 
                ويحافظ على وظائفها الطبيعية.
              </p>
        ...
        <section className={styles.relatedSection}>
          <div className={styles.container}>
            ...
            <div className={styles.relatedGrid}>
              <Link href="/emergency-surgeries/testicular-torsion" className={styles.relatedCard}>
