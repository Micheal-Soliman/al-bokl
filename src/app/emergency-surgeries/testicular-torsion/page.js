...
export async function generateMetadata() {
  return generateSEOMetadata({
    ...
    description:
      "التواء الخصية هو التفاف الخصية حولين نفسها وبيمنع وصول الدم للخصية، والحالة دي لازم تتلحق بسرعة لان الخصية ممكن يحصلها ضمور، وكده مش هيكون فى فرصة للإنجاب.",
    keywords: [
      "التواء الخصية",
      "التواء الخصية الطارئ",
      "عملية التواء الخصية",
      "ألم الخصية المفاجئ",
      "جراحة الطوارئ",
      "د أسامة البكل",
...
export default function TesticularTorsionPage() {
  const torsionDefinition = {
    title: "التواء الخصية",
    description:
      "مش كل الم نقدر نصبر عليه و ناخدله مسكن وخلاص، فى الم لو حسينا بيه لازم نلحق نعالج سببه لان لو اتأخرنا فى علاجة هنوصل نفسنا لاستأصال الخصية، وده اللى هيحصل لو كان عندنا التواء فى الخصية و ملحقناش نعالجة فى اقل من 6 ساعات.",
    mechanism:
      "و عشان نفهم ازاى الخصية بتضر بسبب الالتواء ده ، خلونا نعرف الاول ان الخصية بتكون موجوده فى كيس الصفن و بتكون متعلقة فى الحبل المنوى ، و الحبل المنوى ده بيكون فيه مجموعة من الشرايين اللى بتكون مسؤوله انها توصل الدم و الاكسجين للخصية عشان يغذيها ، و بيكون فيه كمان الاوردة و دى اللى بتكون مسؤولة عن انها تخرج بقايا الدم من الخصية بعد ما تكون استفادة منه للدوره الدموية مرة تانية ، و بيكون كمان فيه الانابيب المنوية اللى بتخرج الحيوانات المنوية من الخصية للحويصله المنوية ، فلما الخصية تلف حوالين نفسها هيبدء كمان الحبل المنوى اللى متعلقة فيه الخصية يحصل فيه التفاف و بسبب الالتفاف ده الشرايين و الاوره بتتقفل و بكده الدم مش بيوصل للخصية ، و بيبدء يحصل للخصية اختناق و تلف فى الانسجة ، و هيبدء لونها يتغير و يبقى مزرق بسبب نقص الدم و الاكسجين ، و هنا لازم نروح فوراّ للمستشفى عشان نلحق الخصية ، لاننا لو اتأخرنا مش هنقدر نعالج التلف اللى حصل للانسجة و بكده هيحصل ضمور و غرغرينة للخصية و هنضطر نستأصلها .",
  };
  ...
  const torsionSymptoms = [
    ...
    `و هنا لازم تعرف ان و لو حسينا بالاعراض دى لازم فورا نروح لمستشفى ، و نعمل فحص سريع بأشعه الدوبلر عشان نتأكد من وضع الدوره الدموية فى الخصية ، و لو اتأكدنا من وجود التواء بالخصية لازم نكون بنجهزعشان هنعمل عمليه نلحق بيها الخصية قبل ما يحصلها ضمور و غرغرينة

العمليه نفسها بتكون بسيطة جدا مش بتاخد اكتر من 45 دقيقة ، كل اللى بنعمله فيها فتحة صغيره فى كيس الصفن ، عشان نخرج منها الخصية ، و بعدين نفك الالتواء اللى حصل و نحاول اننا ننعش الخصية مره تانية ، و هنا لو لقينا ان لونها بدء يرجع تانى للطبيعى ، وقتها هتبقى الخصية سليمة و هنبدء نرجعها تانى لكيس الصفن و نثبتها فيه بخيط جراحى عشان الالتواء ميحصلش مره تانية .`,
  ];
    ...
    <MainLayout>
      <div className={styles.emergencyPage}>
          ...
          <div className={styles.container}>
            <div className={styles.heroContent}>
              <div className={styles.breadcrumb}>
                ...
                <span style={{ color: "#64748b" }}>/</span>
                <span style={{ color: "#1e293b" }}>التواء الخصية</span>
              </div>
            </div>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.definitionCard}>
              <p className={styles.definitionText}>
                {torsionDefinition.description}
              </p>

              <div className={styles.mechanismExplanation}>
                <h3 className={styles.subTitle}>
                  طيب دلوقتى بعد ما عرفنا يعنى اي التواء الخصية
                </h3>
                <p className={styles.mechanismText}>
                  {torsionDefinition.mechanism}
                </p>
              </div>
            </div>
          </div>
        ...
        <section className={styles.causesSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>
              تعالوا بقى نعرف ليه ممكن يحصل التواء للخصية ؟
            </h2>
        ...
        <section className={styles.symptomsSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>
              طيب اى اللى المفروض تحس بيه لو عندك التواء فى الخصية ؟
            </h2>
          ...
          <div className={styles.container}>
            <div className={styles.finalMessageCard}>
              <p className={styles.finalMessageText}>
                {finalMessage.importance}
              </p>
              <p className={styles.finalMessageText}>
                {finalMessage.conclusion}
              </p>
            </div>
          </div>
        </section>
        ...
        {/* <section className={styles.ctaSection}>
          <div className={styles.container}>
            <div className={styles.ctaContent}>
              ...
              <p>
                التواء الخصية حالة طوارئ تحتاج تدخل فوري. لا تتأخر في طلب
                المساعدة الطبية لإنقاذ الخصية والحفاظ على قدرتك على الإنجاب.
              </p>
