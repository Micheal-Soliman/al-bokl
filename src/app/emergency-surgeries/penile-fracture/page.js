...
export async function generateMetadata() {
  return generateSEOMetadata({
    ...
    description: "كسر القضيب من الإصابات الخطيرة اللي بتحصل في العضو الذكري اثناء الانتصاب في العلاقة الزوجية، وليه أسباب كثيرة، وعلاجه الوحيد هو التدخل الجراحي",
    keywords: ["كسر القضيب", "إصابة العضو الذكري", "كسر العضو الذكري", "جراحة طوارئ", "د أسامة البكل", "النسيج الكهفي", "الانتصاب", "العلاقة الزوجية"],
...
export default function PenileFracturePage() {
  ...
  const fractureTypes = [
    {
      type: "كسر كلى",
      description: "و هنا الكسر بيكون فى كل طبقات الجدار اللى بيغطى النسيج الكهفى، و فى الحالة دى بيبدء الدم يخرج الدم من النسيج الكفى و يتجمع تحت الجلد، و لو كان الكسر ده شديد ممكن يوصل كمان لمجرى البول و يسببله تهتك"
    },
    {
      type: "كسر جزئى",
      description: "وده بيحصل فيه كسر فى طبقه واحده من طبقات الجدار اللى بيغلف النسيج الكهفى، و على الاغلب بتكون الطبقة الداخليه، و هنا مش بيكون فى تجمع دموى تحت الجلد"
    }
  ];
    ...
    <MainLayout>
      <div className={styles.emergencyPage}>
        ...
        <section className={styles.definitionSection}>
          <div className={styles.container}>
            ...
            <div className={styles.definitionCard}>
              <p className={styles.definitionText}>{fractureDefinition.description}</p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.causesSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>طيب هو ليه ممكن يحصل كسر للقضيب اصلا ؟</h2>
            <div className={styles.causesCard}>
              <h4 className={styles.causesSubtitle}>كسر القضيب بيكون ليه اسباب كتير زى :</h4>
        ...
        <section className={styles.treatmentSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>طيب فى حالة ان حصل كسر فى القضيب هيكون ايه العلاج ؟</h2>
        ...
        <section className={styles.complicationsSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>طيب لو معمالناش العمليه اى اللى هيحصل ؟</h2>
              ...
              <ul className={styles.complicationsList}>
                {complications.map((complication, index) => (
                  <li key={index} className={styles.complicationItem}>
                    ...
                    <span className={styles.complicationText}>{complication}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <section className={styles.postOpSection}>
          <div className={styles.container}>
            <h2 className={styles.sectionTitle}>و دلوقت خلينى اقولك على كام حاجة لازم تتعمل بعد العمليه، عشان ميحصلناش اى مضاعفات :</h2>
        ...
        <section className={styles.ctaSection}>
          <div className={styles.container}>
            <div className={styles.ctaContent}>
              ...
              <p>
                كسر القضيب حالة طوارئ تحتاج تدخل جراحي فوري. العلاج المبكر يضمن الشفاء التام 
                والعودة للحياة الطبيعية دون مضاعفات.
              </p>
        ...
        <section className={styles.relatedSection}>
          <div className={styles.container}>
            ...
            <div className={styles.relatedGrid}>
              <Link href="/surgeries/penile-curvature" className={styles.relatedCard}>
